...
describe('Custom Tests', function () {
  ...
  it('[assignment] ii. deposit 0.1 ETH in L1 -> withdraw 0.08 ETH in L2 -> assert balances', async () => {
    ...
    // The recepient balance will be equal to the amount that is withdrawn i.e. 0.08
    // The omniBridge balance will be 0 as all the funds had been withdrawn
    // The tornadoPool balance will be the difference in deposit and withdrawn i.e 0.02
  ...
  it('[assignment] iii. see assignment doc for details', async () => {
    ...
    //Recipient balance should be 0 and omniBridge balance should be equal to remaining 
    //amount withdrawn by Alice since transaction takes place in L1
     const recipientBalance = await token.balanceOf(recipient)
     console.log('recipientBalance = ', (recipientBalance / 1000000000000000000))
